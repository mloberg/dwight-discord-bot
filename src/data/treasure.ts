...
export function crIndex(cr: number) {
    if (cr <= 4) {
        return "0-4";
    }
    if (cr <= 10) {
...
export default {
    individual: {
        "0-4": [
            ...new Array(30).fill([ // 1–30
                ["5d6", "cp"],
            ]),
            ...new Array(30).fill([ // 31–60
                ["5d6", "sp"],
            ]),
            ...new Array(10).fill([ // 61–70
                ["3d6", "ep"],
            ]),
            ...new Array(25).fill([ // 71–95
                ["3d6", "gp"],
            ]),
            ...new Array(5).fill([ // 96–100
                ["1d6", "pp"],
            ]),
        ],
        "5-10": [
        ...
        "11-16": [
            ...
            ...new Array(15).fill([ // 21–35
                ["1d6×100", "ep"],
                ["1d6×100", "gp"],
            ]),
            ...new Array(40).fill([ // 36–75
                ["2d6×100", "gp"],
                ["1d6×10", "pp"],
            ]),
            ...new Array(25).fill([ // 76–00
                ["2d6×100", "gp"],
                ["2d6×10", "pp"],
            ]),
        ],
        "17+": [
            ...new Array(15).fill([ // 1–15
                ["2d6×1000", "ep"],
                ["8d6×100", "gp"],
            ]),
            ...new Array(40).fill([ // 16–55
                ["1d6×1000", "gp"],
                ["1d6×100", "pp"],
            ]),
            ...new Array(45).fill([ // 56–100
                ["1d6×1000", "gp"],
                ["2d6×100", "pp"],
            ]),
        ],
